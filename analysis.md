...
- 1순위 "금액" 우선순위 반영 — 21,250,000원 (예상의 90%)
...
### 금액·기간
- **지원 금액**: 21,250,000원 (VAT 별도) — 클라이언트 예상의 85% (사용자 조정)
...
### 1순위(금액) 대응 전략
- 클라이언트 예상의 85% 지원 (21,250,000원)으로 경쟁력 강화 — 1순위(금액) 적극 대응
...
3. 비용 사전 협의 — 본 제안 금액은 21,250,000원(VAT 별도)이며, 견적서 페이지에 8개 라인 아이템으로 산정 근거를 명시하였습니다. 미팅 시 PLC 환경 상세에 따라 일부 항목 조정 협의 가능합니다.
